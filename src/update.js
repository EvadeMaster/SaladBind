		...
		fetch('https://raw.githubusercontent.com/EvadeMaster/SaladBind/main/internal/changelog.json')
			...
			.then(data => {
				...
				files = { //files to download if the user decides to autoupdate.
					"win32": { "file": `https://github.com/EvadeMaster/SaladBind/releases/download/v${version}/saladbind-win.exe`, "name": `SaladBind-win-${version}.exe` },
					"linux": { "file": `https://github.com/EvadeMaster/SaladBind/releases/download/v${version}/saladbind-linux`, "name": `SaladBind-linux-${version}` },
					"darwin": { "file": `https://github.com/EvadeMaster/SaladBind/releases/download/v${version}/saladbind-macos`, "name": `SaladBind-macos-${version}` }
				}
